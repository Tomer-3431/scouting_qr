                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        Selector<CollectionZone>(
                          ...
                          placeholder:
                              "Select Where The Robot Collected Corals",
                          makeItem: (CollectionZone collectionZone) =>
                              collectionZone.title,
                            ...
                            RoundedIconButton(
                                ...
                                onPress: () {
                                  if (collectionZone != null) {
                                    widget.gameData.teleoparetedData =
                                        TeleoparetedData(
                                            l4Scored: l4Scored,
                                            l3Scored: l3Scored,
                                            l2Scored: l2Scored,
